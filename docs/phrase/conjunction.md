...
| 目的 | 常用用法 | 常用句  | 范文 |
| --- | --- | --- |  --- |
| 新增信息	| Also; Additionally; Furthermore; Moreover	| “Furthermore, the data shows that X is a significant factor.”“In addition to the above-mentioned study, Rogers also presents…” |“Furthermore, the data shows that X is a significant factor.”“In addition to the above-mentioned study, Rogers also presents…” |
